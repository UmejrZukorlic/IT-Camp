...
function guess() {
    ...
    document.getElementsByClassName("btn")[0].removeAttribute("oclick")
    document.getElementsByClassName("btn")[1].removeAttribute("oclick")
    document.getElementsByClassName("btn")[2].removeAttribute("oclick")
}
